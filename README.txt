...
This is the readme for SolarSystem, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. SolarSystem) > Ok.
...
- To run the project find SolarSystem.java (which will be in under src/main/java/solarsystem) and right click > Run 'SolarSystem'
